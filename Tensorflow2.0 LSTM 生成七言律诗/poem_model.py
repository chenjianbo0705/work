...
class PoetryModel(object):
    def __init__(self, config):
        ...
        # 文件预处理
        self.word2numF, self.num2word, self.words, self.files_content,self.po = preprocess_file(self.config)
    ...
    def predict_random(self, temperature=1):
        ...
        if not self.model:
            ...
            return
        #andom.randint()方法里面的取值区间是前闭后闭区间
    ...
    def predict_first(self, char, temperature=1):
        ...
        generate += self._preds(sentence, length=31, temperature=temperature)
        return generate
    ...
    def predict_sen(self, text, temperature=1):
        ...
        generate += self._preds(sentence, length=32 - max_len, temperature=temperature)
        return generate
    ...
    def train(self):
        ...
        number_of_epoch /= self.config.batch_size         #32
        ...
        self.model.fit_generator(
            ...
            callbacks=[
                keras.callbacks.ModelCheckpoint(self.config.weight_file, save_weights_only=True),
